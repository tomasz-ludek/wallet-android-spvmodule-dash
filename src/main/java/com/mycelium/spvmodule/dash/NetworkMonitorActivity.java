...
import com.mycelium.spvmodule.dash.ui.ViewPagerTabs;

/**
 * @author Andreas Schildbach
 */
public final class NetworkMonitorActivity extends ToolbarActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setTitle(R.string.network_monitor_activity_title);
        showBackButton();
